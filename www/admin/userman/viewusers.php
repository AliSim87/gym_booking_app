    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                echo "<a style='margin-right: 5px;' href='adduser.php' class='btn btn-primary m-b-1em'>Add a User</a>";
                ...
                if ($result = mysqli_query($db, $sql)) {
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td>";
                            echo "<a style='margin-right: 5px;' href='edituser.php?id={$id}' class='btn btn-primary m-r-1em'>Edit</a>";
