...
if (!isset($_SESSION['loggedin'])) {
    ...
    exit;
} elseif ($_SESSION['user_level'] != 'instructor') {
    header('Location: index.html');
    exit;
}
?>
    ...
    <div class="boxed">
        ...
        <div id="content-container">
            ...
            <div id="page-content">
                ...
                echo "<a href='createaclass.php' class='btn btn-primary m-b-1em'>Create a Class</a>";
                ...
                if ($result = mysqli_query($db, $sql)) {
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td>&#163;{$cost}</td>";
                            echo "<td>";
                            echo "<a href='viewaclass.php?id={$id}' class='btn btn-info m-r-1em'>More Information</a>";
