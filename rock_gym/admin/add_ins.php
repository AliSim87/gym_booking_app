...
if (!empty($_POST)) {
    ...
    $stmt = $pdo->prepare('INSERT INTO instructors VALUES (?, ?, ?, ?)');
...
<head>
    ...
    <title>Dashboard | Add a Gym Instructor</title>
    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <div class="content update">
                <h2>Add a Gym Instructor</h2>
                <form action="add_ins.php" method="post">
