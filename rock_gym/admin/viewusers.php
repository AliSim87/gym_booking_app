...
<head>
    ...
    <title>Rockdale Gym | View Users</title>
    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
        <div class="container-fluid d-flex flex-column p-0">
            ...
            <ul class="nav navbar-nav text-light" id="accordionSidebar">
                ...
                <li class="nav-item" role="presentation"><a class="nav-link active" href="classes.php"><i class="fas fa-table"></i><span>Class Schedules</span></a></li>
            </ul>
    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4">Active Users</h3>
                <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 font-weight-bold"><a href="viewinsts.php" class="create-contact">View Instructors</a></p>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        </div>
                            ...
                            <table class="table dataTable my-0" id="dataTable">
                                ...
                                <?php foreach ($accounts as $account): ?>
                                    <tr>
                                        ...
                                        <td><?=$account['email']?></td>
                                        <td class="actions">
                                            <a href="update_user.php?id=<?=$account['id']?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
                                            <a href="delete_user.php?id=<?=$account['id']?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
