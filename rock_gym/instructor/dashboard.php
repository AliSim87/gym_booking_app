...
<style>
    .bg-gradient-primary {
        background-image: linear-gradient(180deg,#625da7 10%,#8e9022b8)!important;
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="classes.php"><i class="fas fa-table"></i><span>Schedule</span></a></li>
                </ul>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">Hello <?=$_SESSION['name']?>!</h3><br><br>
                    <div class="row">
                            ...
                            <div class="card shadow border-left-success py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>ADD NEW CLASS</span></div>
                                            <div class="text-dark font-weight-bold h5 mb-0"><span><a href = 'add_class.php'>Add Class</a></span></div>
                                        </div>
