...
if (!empty($_POST)) {
    ...
    $stmt = $pdo->prepare('INSERT INTO classes VALUES (?, ?, ?, ?)');
    $stmt->execute([$id, $name, $time, $instructor]);
    // Output message
...
<head>
    ...
    <title>Dashboard - Add a Gym Class</title>
        ...
        <div id="content">
            ...
            <div class="content update">
                ...
                <form action="add_class.php" method="post">
                    ...
                    <input type="text" name="instructor" placeholder="Instructor Name" id="instructor">
